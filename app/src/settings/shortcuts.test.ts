...
describe("the default shortcuts (keymap.md)", () => {
  test("⌘K ⌘1 ⌘2 ⌘3 ⌘4 ⌘5 ⌘S ⌘, raise their actions (⌘1 is Home and ⌘4 Usage since 2026-09-22, ⌘3 Crew since 2026-09-24, ⌘5 Inbox since 2026-09-25)", () => {
    ...
    expect(actionForEvent(press("5", "Digit5"), DEFAULT_SHORTCUTS)).toBe("go.inbox");
    expect(actionForEvent(press("6", "Digit6"), DEFAULT_SHORTCUTS)).toBeNull();
