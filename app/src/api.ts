...
export interface CrewSnapshot {
  ...
  /** Every GitHub repository already in the crew — a task's, or a clone Firstmate has — for Add to crew. */
  crew_repos: string[];
}
...
/** **Add to crew** on a client folder (ADR 0017): the first mate started with the sentence, or it on the clipboard. */
export const addToCrew = (path: string) => invoke<"launched" | "copied">("crew_add", { path });
