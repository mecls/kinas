...
// remounted). Detach waits for a Herdr-CLI door; Copy is the existing copy path. The badge is drawn only when the
// caller knows the state: a badge that always says the same word says nothing.
