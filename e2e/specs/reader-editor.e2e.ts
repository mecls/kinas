...
import { herdr, herdrSnapshot, hook, runReaderMenuItem, stopHerdrSession, waitForHook } from "../helpers.ts";
...
describe("Open in editor", () => {
  ...
  it("splits the focused Herdr pane with the editor from Settings on the file", async () => {
    ...
    // Through the header's ▾ menu, where Open in editor has lived since 2026-09-18, and clicked in the page: element
    // lookups cost about 5 s each under this driver.
    await runReaderMenuItem("Open in editor");
